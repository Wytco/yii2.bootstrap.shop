                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <p>
                                                ...
                                                ?>
                                                <a href="<?= Url::to(['product/view', 'slug' => $hit->slug]) ?>"><?= $name ?></a>
                                            </p>
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li>
                                                <a class="add-to-wishlist" data-id="<?= $hit->id ?>" href="<?= Url::to(['wishlist/add', 'id' => $hit->id]) ?>"><i class="fa fa-plus-square"></i>Add to wishlist</a>
                                            </li>
