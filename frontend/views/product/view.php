...
if (count($params) >= 1) {
    $code = unserialize($products->lang);
    $data = $code[$language];
    $name = $data['name'];
    $content = $data['content'];
    $cat = unserialize($products->category->name);
    $cat_name = $cat[$language];
} else {
    $name = $products->name;
    $content = $products->content;
    $cat_name = $products->category->name;
}
                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            <?= Html::img($products->img, ['alt' => $name]) ?>
                            <h3>ZOOM</h3>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php elseif ($products->sale): ?>
                                <?= Html::img('@web/images/home/sale.png', ['alt' => 'Новинка', 'class' => 'newarrival']) ?>
                            <?php endif; ?>
                            ...
                            <span>
									...
									<a href="<?= Url::to(['cart/add', 'id' => $products->id]) ?>"
                                       data-id="<?= $products->id ?>" class="btn btn-fefault cart add-to-cart">
